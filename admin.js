...
/* --- la bibliothèque Supabase est-elle bien arrivée ? --- */
if(typeof supabase === 'undefined'){
  document.addEventListener('DOMContentLoaded', () => {
    const z = document.getElementById('err-connexion');
    if(z){
      z.textContent = "La bibliotheque Supabase n'a pas pu etre chargee. Verifiez votre connexion Internet, ou desactivez un eventuel bloqueur sur cette page.";
      z.hidden = false;
    }
  });
}
